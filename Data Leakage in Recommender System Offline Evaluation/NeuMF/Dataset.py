...
class Dataset(object):
    ...
    def __init__(self, path,selected_year, num_years_added):
        self.trainMatrix, self.trainList, self.available_items, self.num_ratings = self.load_rating_file_as_matrix(path+"data.data.RATING",path + "train.train.RATING", selected_year, num_years_added)
        self.testRatings, self.testUsers = self.load_rating_file_as_list(path + "test.train.RATING",selected_year)
