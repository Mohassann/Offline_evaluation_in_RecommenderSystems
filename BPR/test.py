...
from dataloader import LoadRatingFile_HoldKOut_year_test
import numpy as np
import argparse
...
train, test, available_items, num_user, num_item, num_ratings = LoadRatingFile_HoldKOut_year_test(data_path+data+'/', splitter, hold_k_out,selected_year, num_years_added)
